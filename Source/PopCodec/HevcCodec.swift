...
public struct HevcCodec : Codec
{
	...
	func GetMetaAtoms(parent:any Atom) -> [any Atom]
	{
		...
		{
			parameter in
			var packetMeta = InfoAtom(info: "\(parameter.contentTypeLabel) x\(parameter.totalSize)", filePosition: parameter.filePosition, totalSize: parameter.totalSize)
			packetMeta.childAtoms = parameter.nalus.map
			{
				nalu in
